...
const AppIds = (props) => {
    ...
    return (
        <div>
            {chosenApp ?
                (
                    <AppId chosenApp={chosenApp} setDeleted={setDeleted} token={token} setChosenApp={setChosenApp} />
                ) : (
                    <div>
                        {newApp && <NewAppId setNewApp={setNewApp} setAdded={setAdded} token={token} setChosenApp={setChosenApp} />}
                        {!newApp && <>
